...
export const addProduct = async (req, res) => {
  try {
    const {productName, productDescription, productType, productQty} = req.body;
    const newProduct = new Product({productName, productDescription, productType, productQty});
